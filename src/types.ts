...
export type OverviewResponse = { status: DvrStatus; counts?: DvrCounts; indices?: DvrIndices }
export type ChannelsResponse = { channels: Channel[] }
export type CurrentTimeResponse = { timeText: string | null; iso: string | null }
export type HddResponse = { hddLines: string[] }
